import { Controller, Get, Put, Delete, Body, Req, UseGuards, HttpCode, HttpStatus } from '@nestjs/common';
...
export class UsersController {
  ...
  getSettings(@Req() req: any) { return this.usersService.getSettings(req.user.id); }
